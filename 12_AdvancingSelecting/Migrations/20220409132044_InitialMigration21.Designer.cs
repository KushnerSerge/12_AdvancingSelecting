...
namespace _12_AdvancingSelecting.Migrations
{
    ...
    [Migration("20220409132044_InitialMigration21")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.AuthorBook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("de9fd1a4-6646-4187-a8be-7449c68b21ae"),
                            ...
                            Price = 120m,
                            PublishedOn = new DateTime(2015, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("8e5e91de-36c1-41e0-b341-c1b356022fa2"),
                            Title = "Big Data: Principles and best practices of scalable realtime data systems"
                        },
                        new
                        {
                            Id = new Guid("642e9d6f-e623-4e28-b459-7b0f79c2c707"),
                            ...
                            Price = 35m,
                            PublishedOn = new DateTime(2018, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("8e5e91de-36c1-41e0-b341-c1b356022fa2"),
                            Title = "Kubernetes in Action"
                        },
                        new
                        {
                            Id = new Guid("dc5e25af-49f0-47fc-9500-6c2be2f27543"),
                            ...
                            Price = 50m,
                            PublishedOn = new DateTime(2014, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("f120b006-38a7-4557-a110-da6495e56d55"),
                            Title = "Adaptive Code via C#: Agile coding with design patterns and SOLID principles (Developer Reference)"
                        },
                        new
                        {
                            Id = new Guid("a9b9a4f4-a282-4019-a2ba-7f8a39a213d2"),
                            ...
                            Price = 45m,
                            PublishedOn = new DateTime(2013, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("8e5e91de-36c1-41e0-b341-c1b356022fa2"),
                            Title = "C# in Depth, 3rd Edition"
                        },
                        new
                        {
                            Id = new Guid("8cfaea67-2a99-4883-9601-bd50c6d08b9e"),
                            ...
                            Price = 40m,
                            PublishedOn = new DateTime(2012, 9, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("2c42e67e-46e6-42a6-b0b0-6ad516a861d7"),
                            Title = "SQL Server 2012 Query Performance Tuning (Expert's Voice in SQL Server)"
                        },
                        new
                        {
                            Id = new Guid("a01bc1f3-b336-4dd3-bf2d-1d9f702b3eb4"),
                            ...
                            Price = 32m,
                            PublishedOn = new DateTime(2017, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("89f3cf78-c864-4cd4-965f-10072b9986af"),
                        ...
                        new
                        {
                            Id = new Guid("4c111116-5f32-49bb-934e-2d470b80ace3"),
                            ...
                            Price = 45m,
                            PublishedOn = new DateTime(2014, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublisherId = new Guid("c0b9b67b-2408-41c1-b1fb-50e204d1820c"),
                            Title = "Concurrency in C# Cookbook: Asynchronous, Parallel, and Multithreaded Programming"
                        });
                });

            modelBuilder.Entity("_12_AdvancingSelecting.Entities.PriceOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.Publisher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.AuthorBook", b =>
                {
                    b.HasOne("_12_AdvancingSelecting.Entities.Author", "Author")
                        .WithMany("AuthorBooks")
                        .HasForeignKey("AuthorId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_12_AdvancingSelecting.Entities.Book", "Book")
                        .WithMany("AuthorBooks")
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.Book", b =>
                {
                    b.HasOne("_12_AdvancingSelecting.Entities.Publisher", "Publisher")
                        .WithMany()
            ...
            modelBuilder.Entity("_12_AdvancingSelecting.Entities.PriceOffer", b =>
                {
                    b.HasOne("_12_AdvancingSelecting.Entities.Book", "Book")
                        .WithOne("PriceOffer")
                        .HasForeignKey("_12_AdvancingSelecting.Entities.PriceOffer", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
